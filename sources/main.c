...
#pragma region allegro initialization
    ...
    int cutscene_two_on = 0;

    int cutscene_three_on = 0;
...
#pragma region loading sprites
    ...
    BITMAP *hell_platform_sprite = load_bitmap(HELL_GROUND_PLATFORM, NULL);
    if (hell_platform_sprite == NULL)
        allegro_message("error");
    ...
    BITMAP *cave_background_sprite = load_bitmap("../assets/Scenario/CaveBackGround1.bmp", NULL);
    if (cave_background_sprite == NULL)
        allegro_message("error");

    BITMAP *cave_background_sprite_2 = load_bitmap("../assets/Scenario/CaveBackGround2.bmp", NULL);
    if (cave_background_sprite_2 == NULL)
        allegro_message("error");
    ...
    //2 - fading out to black
    int fading_type = 0;
    float fading_progress = 0;
    BITMAP *fade_black = create_bitmap(SCREEN_W, SCREEN_HEIGHT);
...
#pragma region cutscene two
        ...
        BITMAP *cena_two_two = load_bitmap("../assets/Cutscenes/Cutscene_two/Cena2.bmp", NULL);
        BITMAP *cena_two_three = load_bitmap("../assets/Cutscenes/Cutscene_two/Cena3.bmp", NULL);
        //SAMPLES
        SAMPLE *selec = load_sample(SELECT_SOUND);
        ...
        while (cutscene_two_on && !close_game)
        {
            if (fading_type == 0)
            {
                keyboard_input();
            ...
            while (counter > 0)
            {
                ...
                if (scene_show == 1)
                {
                    pschx = 783;
                    pschy = 476;
                    draw_sprite(buffer, cena_two_one, 0, 0);
                }
                if (scene_show == 2)
                {
                    pschx = 783;
                    pschy = 476;
                    draw_sprite(buffer, cena_two_two, 0, 0);
                }
                if (scene_show == 3)
                {
                    pschx = 783;
                    pschy = 476;
                    draw_sprite(buffer, cena_two_three, 0, 0);
                }
        ...
        destroy_bitmap(cena_two_one);
        destroy_bitmap(cena_two_two);
        destroy_bitmap(cena_two_three);
...
#pragma region generating second level second part
            ...
            scenario_map_size = readMap(&scenario_map, "../sources/level_2_2_scenario.txt");
            ...
            for (int i = 0; i < map_size; i++)
            {
                if (map[i] == '0' || map[i] == '1' || map[i] == '2' || map[i] == '3' || map[i] == '4' ||
                    ...
                    map[i] == 'f' || map[i] == 'g' || map[i] == 'h' || map[i] == 'i' || map[i] == 'j' ||
                    map[i] == 'L' || map[i] == 'k' || map[i] == 'l' || map[i] == 'm' || map[i] == 'n' ||
                    map[i] == 'x' || map[i] == 'o' || map[i] == 'q' || map[i] == 'r')
                {
                    ground_count++;
                }
                else if (map[i] == 'B' || map[i] == 'F' || map[i] == 'H' || map[i] == 'G' || map[i] == 'I')
            ...
            for (int i = 0; i < scenario_map_size; i++)
            {
                if (scenario_map[i] == '1' || scenario_map[i] == '2' || scenario_map[i] == '3' || scenario_map[i] == '4' || scenario_map[i] == '5' ||
                    scenario_map[i] == '6' || scenario_map[i] == '7' || scenario_map[i] == '8' || scenario_map[i] == '9' || scenario_map[i] == 'a' ||
                    scenario_map[i] == 'b' || scenario_map[i] == 'W' || scenario_map[i] == 'w' || scenario_map[i] == 'C' || scenario_map[i] == 'L' ||
                    scenario_map[i] == 'l' || scenario_map[i] == 't' || scenario_map[i] == 'H' || scenario_map[i] == 'c' || scenario_map[i] == 'd')
                {
                    object_count++;
                }
            }
            ...
            for (int i = 0; i < map_size; i++)
            {
                ...
                {
                    init_ground(&grounds_lvl2[ground_count], create_vector(col * 128, row * 128), 6);
                    ground_count++;
                    col++;
                }
                else if (map[i] == '7')
                {
                    init_ground(&grounds_lvl2[ground_count], create_vector(col * 128, row * 128), 7);
                    ground_count++;
                    col++;
                }
                else if (map[i] == '8')
                ...
                {
                    init_ground(&grounds_lvl2[ground_count], create_vector(col * 128, row * 128), 90);
                    ground_count++;
                    col++;
                }
                else if (map[i] == 'q')
                {
                    init_ground(&grounds_lvl2[ground_count], create_vector(col * 128, row * 128), 91);
                    ground_count++;
                    col++;
                }
                else if (map[i] == 'r')
                {
                    init_ground(&grounds_lvl2[ground_count], create_vector(col * 128, row * 128), 92);
                    ground_count++;
                    col++;
                }
                else if (map[i] == 'h')
            ...
            for (int i = 0; i < scenario_map_size; i++)
            {
                ...
                {
                    init_object(&objects_lvl2[object_count], create_vector(col * 128, row * 128), 31);
                    object_count++;
                    col++;
                }
                else if (scenario_map[i] == 'd')
                {
                    init_object(&objects_lvl2[object_count], create_vector(col * 128, row * 128), 32);
                    object_count++;
                    col++;
                }
                else if (scenario_map[i] == 'L')
                ...
                else if (scenario_map[i] == 'H')
                {
                    init_object(&objects_lvl2[object_count], create_vector(col * 128, row * 128), 30);
                    object_count++;
                    col++;
                }
                else if (scenario_map[i] == '*' || scenario_map[i] == 'X')
            ...
            for (int i = 0; i < ground_count; i++)
            {
                ...
                if (!(strcmp(grounds_lvl2[i].rb.cb.tag, "platform") == 0 || strcmp(grounds_lvl2[i].rb.cb.tag, "bridge") == 0 || strcmp(grounds_lvl2[i].rb.cb.tag, "lava") == 0))
                {
                    if (grounds_lvl2[i].animation_frame >= 90)
                    {
                        if (grounds_lvl2[i].animation_frame == 90)
                        {
                            grounds_lvl2[i].animation_frame = 1;
                        }
                        else if (grounds_lvl2[i].animation_frame == 91)
                        {
                            grounds_lvl2[i].animation_frame = 4;
                        }
                        else if (grounds_lvl2[i].animation_frame == 92)
                        {
                            grounds_lvl2[i].animation_frame = 0;
                        }

                        draw_ground(level_background, hell_sprite, &grounds_lvl2[i], create_vector(0, 0));
                    }
                    else
                    {
                        draw_ground(level_background, cave_sprite, &grounds_lvl2[i], create_vector(0, 0));
...
#pragma endregion
            ...
            while (playing_second_level_2 && !close_game)
            {
                ...
                while (counter > 0)
                {
                    ...
                    masked_blit(cave_background_sprite_2, buffer, camera.x, camera.y, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
...
#pragma region cutscene three
        ...
        //BITMAPS
        BITMAP *cena_three_one = load_bitmap("../assets/Cutscenes/cutscene_three/Cena1.bmp", NULL);
        BITMAP *cena_three_two = load_bitmap("../assets/Cutscenes/cutscene_three/Cena2.bmp", NULL);
        BITMAP *cena_three_three = load_bitmap("../assets/Cutscenes/cutscene_three/Cena3.bmp", NULL);
        BITMAP *cena_three_four = load_bitmap("../assets/Cutscenes/cutscene_three/Cena4.bmp", NULL);
        ...
        while (cutscene_three_on && !close_game)
        {
            if (fading_type == 0)
            {
                keyboard_input();
            ...
            while (counter > 0)
            {
                ...
                if (scene_show == 1)
                {
                    pschx = 783;
                    pschy = 476;
                    draw_sprite(buffer, cena_three_one, 0, 0);
                }
                else if (scene_show == 2)
                {
                    pschx = 783;
                    pschy = 476;
                    draw_sprite(buffer, cena_three_two, 0, 0);
                }
                else if (scene_show == 3)
                {
                    draw_sprite(buffer, cena_three_three, 0, 0);
                }
                else if (scene_show == 4)
                {
                    pschy = 476;
                    pschx = 783;
                    draw_sprite(buffer, cena_three_four, 0, 0);
                }
                    ...
                    else
                    {
                        if (jumper_boss.animation_frame >= 10 && jumper_boss.animation_frame <= 15)
                        {
                            if (game_timer % 8 == 0)
                            {
                                ...
                                {
                                    jumper_boss.animation_frame = 18;
                                    jumper_boss.rb.cb.enabled = 0;
                                }
                            }
                        }
...
#pragma region cutscene Final
        ...
        BITMAP *cena_final_two = load_bitmap("../assets/Cutscenes/cutscene_final/Cena2.bmp", NULL);
        BITMAP *cena_final_three = load_bitmap("../assets/Cutscenes/cutscene_final/Cena3.bmp", NULL);
        BITMAP *cena_final_four = load_bitmap("../assets/Cutscenes/cutscene_final/Cena4.bmp", NULL);
        BITMAP *cena_final_five = load_bitmap("../assets/Cutscenes/cutscene_final/Cena5.bmp", NULL);
        BITMAP *cena_final_six = load_bitmap("../assets/Cutscenes/cutscene_final/Cena6.bmp", NULL);
        BITMAP *cena_final_seven = load_bitmap("../assets/Cutscenes/cutscene_final/Cena7.bmp", NULL);
        BITMAP *cena_final_eight = load_bitmap("../assets/Cutscenes/cutscene_final/Cena8.bmp", NULL);
        BITMAP *cena_final_nine = load_bitmap("../assets/Cutscenes/cutscene_final/Cena9.bmp", NULL);
        ...
        while (cutscene_final && !close_game)
        {
            if (fading_type == 0)
            {
                keyboard_input();
            ...
            while (counter > 0)
            {
                ...
                if (scene_show == 1)
                {
                    draw_sprite(buffer, cena_final_one, 0, 0);
                }
                else if (scene_show == 2)
                {
                    draw_sprite(buffer, cena_final_two, 0, 0);
                }
                else if (scene_show == 3)
                {
                    pschy = 323;
                    draw_sprite(buffer, cena_final_three, 0, 0);
                }
                else if (scene_show == 4)
                {

                    draw_sprite(buffer, cena_final_four, 0, 0);
                }
                else if (scene_show == 5)
                {
                    draw_sprite(buffer, cena_final_five, 0, 0);
                }
                else if (scene_show == 6)
                {
                    pschy = 323;
                    draw_sprite(buffer, cena_final_six, 0, 0);
                }
                else if (scene_show == 7)
                {
                    pschy = 323;
                    draw_sprite(buffer, cena_final_seven, 0, 0);
                }
                else if (scene_show == 8)
                {
                    pschy = 323;
                    draw_sprite(buffer, cena_final_eight, 0, 0);
                }
                else if (scene_show == 9)
                {
                    pschy = 323;
                    draw_sprite(buffer, cena_final_nine, 0, 0);
                }
        ...
        destroy_bitmap(cena_final_one);
        destroy_bitmap(cena_final_two);
        destroy_bitmap(cena_final_three);
        destroy_bitmap(cena_final_four);
        destroy_bitmap(cena_final_five);
        destroy_bitmap(cena_final_six);
...
#pragma region destroy bitmaps
    ...
    destroy_bitmap(cave_background_sprite_2);
...
void draw_object(BITMAP *bmp, BITMAP *sprite, Object *scenario, Vector camera)
{
    ...
    else if (scenario->sprite_frame >= 2 && scenario->sprite_frame <= 3 || scenario->sprite_frame >= 18 && scenario->sprite_frame <= 21 || scenario->sprite_frame >= 28 && scenario->sprite_frame <= 29 || scenario->sprite_frame == 31 || scenario->sprite_frame == 32)
    {
